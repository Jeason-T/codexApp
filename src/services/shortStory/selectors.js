const shortStorySelectors = {
  loginCheck: '',
  storyListItem: '',
  storyManageButton: '',
  createStoryButton: '',
  newStoryLink: 'a[href*="/publish/"][href*="enter_from=newstory"]',
  ...
  descriptionInput: '',
  fallbackTexts: {
    storyManage: /短故事|短篇故事|短篇|故事管理|我的短篇|作品管理|创作/,
    createStory: /新建短故事|创建短故事|写短故事|写新故事|新建短篇|创建短篇|写故事|新建|创建/,
    ...
    tags: /添加标签|添加话题|输入标签|标签|话题/,
    category: /选择分类|选择类型|分类|类型|故事分类|短故事分类/,
    cover: /上传封面|添加封面|封面/,
    description: /故事简介|简介|故事描述|描述/,
